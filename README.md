...
````
git clone https://github.com/davidajimati/simple_shell
````
...
## AUTHOR DESCRIPTION
  - We are software engineering student at ALX - Holberton School.
  - We have been studying low-level programming, high-level
 ...
 methodology based on peer-learning and projects.
  - We're a curious pair, adaptable, a fast learner and love developing
 our skills.
